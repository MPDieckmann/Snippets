 ...
 */
var i18n: (text: string, namespace?: string) => string = i18n || ((text: string) => text.toString());
 ...
 */
export function date(string: string, timestamp: number | string | Date = new Date): string {
